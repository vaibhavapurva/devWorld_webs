      ...
      <div className="text-center my-10">
        ...
        {connectionsList.map((connection) => {
          const { _id ,firstName, LastName, photoURL, age, gender, about, skills } =
            connection;
          return (
            <div key={_id}className="flex m-4 p-4 rounded-lg bg-base-300 w-1/2 m-auto my-2">
              <div>
                <img
                  alt="photo"
              ...
              <div className="bg-base-300 p-4">
                <Link to={`/chat/${_id}/${firstName + " " + LastName}`}><button className="btn btn-neutral btn-outline">Chat</button></Link>
              </div>
            </div>
          );
        })}
